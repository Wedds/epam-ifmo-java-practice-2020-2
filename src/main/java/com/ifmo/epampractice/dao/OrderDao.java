...
public class OrderDao implements BasicDaoInterface<OrderEntity> {
    ...
    private static final String SAVE_QUERY = "INSERT INTO ORDERS (car_id, client_id, admin_id, status, rent_start_date, " +
            "rent_end_date, discount) VALUES (?, ?, ?, ?::e_status_order, ?, ?, ?)";
    private static final String UPDATE_QUERY = "UPDATE ORDERS SET (car_id, client_id, admin_id, status, rent_start_date, " +
            "rent_end_date, discount) = (?, ?, ?, ?::e_status_order, ?, ?, ?) WHERE ID = ?";
    ...
    public OrderEntity get(int id) {
        ...
        Connection connection = dbConnector.getConnection();
        try {
            PreparedStatement statement = connection.prepareStatement(GET_QUERY, ResultSet.TYPE_SCROLL_SENSITIVE,
                    ResultSet.CONCUR_READ_ONLY);
    ...
    public void delete(OrderEntity order) {
        ...
        Connection connection = dbConnector.getConnection();
        try {
            PreparedStatement statement = connection.prepareStatement(DELETE_QUERY, ResultSet.TYPE_SCROLL_SENSITIVE,
                    ResultSet.CONCUR_UPDATABLE);
